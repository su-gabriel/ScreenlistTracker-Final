...
export function setupAuth(app: Express) {
  // Set up session - using environment variable for secret or a default
  const sessionSecret = process.env.SESSION_SECRET || "screenlist-session-secret";
  ...
  app.post("/api/login", (req, res, next) => {
    ...
    passport.authenticate("local", (err, user, info) => {
      ...
      if (!user) {
        console.log("Login failed: Invalid credentials for user:", req.body.username);
